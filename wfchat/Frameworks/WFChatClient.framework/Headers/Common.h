...
// add friend message
#define MESSAGE_CONTENT_TYPE_ADDFRIEND 1001

// contract message
#define MESSAGE_CONTENT_TYPE_CONTRACT 1002

// real-time share location message
#define MESSAGE_CONTENT_TYPE_REALTIMELOCATION 1003

//riding status notice
#define MESSAGE_CONTENT_TYPE_RIDING_STATUS_TIP 1004

// contract attitude tip message
#define MESSAGE_CONTENT_TYPE_CONTRACT_ATTITUDE_TIP 1005

// real-time share location notification message
#define MESSAGE_CONTENT_TYPE_REALTIMELOCATION_TIP 1006

// contract had send notification message
#define MESSAGE_CONTENT_TYPE_CONTRACTHASSEND_TIP 1007
