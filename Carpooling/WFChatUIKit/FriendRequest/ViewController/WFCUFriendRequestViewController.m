...
- (void)initSearchUIAndData {
    ...
    self.navigationItem.title = kLocalizedTableString(@"New Friends", @"CPLocalizable");
  ...
  self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:kLocalizedTableString(@"Add Friend title", @"CPLocalizable") style:UIBarButtonItemStyleDone target:self action:@selector(onRightBarBtn:)];
}
