...
- (void)initSearchUIAndData {
    ...
    self.navigationItem.title = kLocalizedTableString(@"Add Friend title", @"CPLocalizable");
...
//
//    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNAVIBARANDSTATUSBARHEIGHT+30, kSCREENWIDTH, kSCREENHEIGHT) style:UITableViewStylePlain];
...
//        [self.navigationController pushViewController:pvc animated:YES];
        ...
        if ([[WFCCIMService sharedWFCIMService] isMyFriend:userInfo.userId]) {
            ...
            vc.conversation = [WFCCConversation conversationWithType:Single_Type target:userInfo.userId line:0];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.searchController.active) {
        ...
        [cell.imageView sd_setImageWithURL:[NSURL URLWithString:userInfo.portrait] placeholderImage:[UIImage imageNamed:@"messege_no_icon"]];
