        ...
        if (@available(iOS 13.0, *)) {
            UIColor *dyColor = [UIColor colorWithDynamicProvider:^UIColor * _Nonnull(UITraitCollection * _Nonnull trainCollection) {
                if ([trainCollection userInterfaceStyle] == UIUserInterfaceStyleLight) {
                    return [UIColor colorWithRed:236.0/255.0 green:236.0/255.0 blue:236.0/255.0 alpha:1];
                }
                else {
...
//        } else {
//            _pluginItems = [@[
//                              [[PluginItem alloc] initWithTitle:kLocalizedTableString(@"Photo", @"CPLocalizable") image:[UIImage imageNamed:@"messege_send_picture"] tag:1],
//                              [[PluginItem alloc] initWithTitle:kLocalizedTableString(@"Location", @"CPLocalizable") image:[UIImage imageNamed:@"messege_send_location"] tag:3],
//                              [[PluginItem alloc] initWithTitle:kLocalizedTableString(@"Msg Contract", @"CPLocalizable") image:[UIImage imageNamed:@"messege_send_contract"] tag:6]
//                              ] mutableCopy];
//        }
