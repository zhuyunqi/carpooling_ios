...
@interface CPMyCollectionAddressVC ()<CPMyAddressCell1Delegate>
...
@implementation CPMyCollectionAddressVC
...
- (void)requestMyAddressByCurrentIndex:(NSUInteger)index{
    ...
    [[NetworkManager shareNetworkManager] POSTUrl:[NSString stringWithFormat:@"%@/api/address/v1/getMyCollectAddress.json", BaseURL] parameters:param success:^(id responseObject) {
