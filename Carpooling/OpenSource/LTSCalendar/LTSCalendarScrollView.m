...
@interface LTSCalendarScrollView()<UIScrollViewDelegate>
...
//    self.bounces = true;
    ...
    self.line = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(calendarView.frame)-1, CGRectGetWidth(self.frame), 1)];
    ...
    if (@available(iOS 13.0, *)) {
        ...
        self.line.backgroundColor = dyColor;
        
    } else {
        // Fallback on earlier versions
        self.line.backgroundColor = [UIColor colorWithRed:240/255.f green:240/255.f blue:240/255.f alpha:1];
    }
